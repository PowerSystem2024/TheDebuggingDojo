...
const educacion = ref([]);
educacion.value = [
    {fecha:'2020', title:'Fundamentos de Programación y Trabajo en Equipo', descripcion:'Iniciamos nuestro viaje de aprendizaje con una sólida formación en los fundamentos de programación y un enfoque en el trabajo colaborativo. Aprendimos a comunicarnos y a trabajar en equipo, sentando las bases para proyectos exitosos', enlace:'https://www.frsr.utn.edu.ar/'},
    {fecha:'2021', title:'Exploración de Tecnologías y Desarrollo Full Stack', descripcion:'Profundizamos en tecnologías front-end y back-end, ampliando nuestras capacidades en el desarrollo de aplicaciones completas. La diversidad en habilidades del equipo nos permite una visión completa en el desarrollo de software.', enlace:'https://www.frsr.utn.edu.ar/'},
    {fecha:'2022', title:'Implementación de Calidad y Seguridad', descripcion:'Incorporamos prácticas de testing manual y ciberseguridad, con especialistas dedicados en ambas áreas. Esto asegura la calidad y protección de nuestros proyectos, garantizando que los sistemas cumplen altos estándares.', enlace:'https://www.frsr.utn.edu.ar/'},
    {fecha:'2023', title:'Aprendizaje Continuo y Nuevas Metodologías', descripcion:'La educación y el aprendizaje continuo son el núcleo de nuestro desarrollo profesional. Nos mantenemos actualizados explorando nuevas metodologías de desarrollo, adoptando ideas innovadoras y avanzando en las mejores prácticas de programación.', enlace:'https://www.frsr.utn.edu.ar/'},
    {fecha:'2024', title:'Compromiso con la Excelencia y Soluciones Tecnológicas Avanzadas', descripcion:'Nos esforzamos por superar las expectativas en cada proyecto, con un enfoque en soluciones creativas y tecnológicamente avanzadas. La excelencia y la satisfacción del cliente son nuestras metas, y enfrentamos cada desafío con pasión y dedicación.', enlase:'https://www.frsr.utn.edu.ar/'},
];
</script>
