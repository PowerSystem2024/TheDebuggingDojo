<script setup>
import proyecto1 from '/src/assets/task-management.jpg';
import proyecto2 from '/src/assets/e-commerce.jpg';
import proyecto3 from '/src/assets/movie-recommendation.jpg';
import proyecto4 from '/src/assets/school-administration.jpg';
...
misProyectos.value = ([
    //esto es un array de objetos que contiene información sobre los proyectos
    {
        id: 1,
        src: proyecto1,
        titulo: "Aplicación de Gestión de Tareas (2020)",
        descripcion: "Desarrollamos una aplicación de gestión de tareas utilizando React para el frontend y Node.js con Express para el backend. La aplicación permite a los usuarios crear, editar, eliminar y marcar tareas como completadas.",
        projectoLink: "https://campus.frsr.utn.edu.ar/",
        githubLink: "https://github.com/PowerSystem2024/TheDebuggingDojo"
    },
    {
        id: 2,
        src: proyecto2,
        titulo: "Plataforma de comercio electrónico (2021)",
        descripcion: "Desarrollamos una plataforma de comercio electrónico completa utilizando Django para el backend y Vue.js para el frontend. La plataforma incluye funcionalidades como gestión de productos, carritos de compra, pasarela de pago integrada con Stripe y autenticación de usuarios.",
        projectoLink: "https://campus.frsr.utn.edu.ar/",
        githubLink: "https://github.com/PowerSystem2024/TheDebuggingDojo"
    },
    {
        id: 3,
        src: proyecto3,
        titulo: "Sistema de Recomendación de Películas (2023)",
        descripcion: "Creamos un sistema de recomendación de películas utilizando Python y aprendizaje automático. Utilicé la biblioteca scikit-learn para desarrollar un modelo de filtrado colaborativo basado en datos de usuarios y sus calificaciones de películas.",
        projectoLink: "https://campus.frsr.utn.edu.ar/",
        githubLink: "https://github.com/PowerSystem2024/TheDebuggingDojo"
    },
    {
        id: 4,
        src: proyecto4,
        titulo: "Sistema de Administración Escolar (2024)",
        descripcion: "Un sistema diseñado para gestionar de manera eficiente la información de una institución educativa. Incluye funcionalidades para la programación de horarios, seguimiento del rendimiento académico, y gestión de inscripciones y perfiles de estudiantes y docentes.",
        projectoLink: "https://campus.frsr.utn.edu.ar/",
        githubLink: "https://github.com/PowerSystem2024/TheDebuggingDojo"
    },
])
